...
[
	...
	default(IUnknown),
	threading(apartment),
	vi_progid("Swish.DummyFolder"),
	progid("Swish.DummyFolder.1"),
	version(1.0),
	registration_script("DummyFolder.rgs"),
	uuid("708F09A0-FED0-46E8-9C56-55B7AA6AD1B2"),
	helpstring("DummyFolder Class")
]
